...
exports.showBottomBar = function() {
    //$.viewShadow.visible = 0;
    $.viewCategorySelect.height = 65;
};

exports.setBottomBar = function() {
    $.viewCategorySelect.removeAllChildren();
};
...
exports.showInfoBar = function(args) {
    ...
    //@TODO formFactor
    args = args || {};
    var duration = args.duration ? args.duration : false;
    ...
    var yes = function() {
        $.imageViewInfoBarIcon2.removeEventListener('click', yes);
        alert('here');
    };
 ...
 * @return {Object} breadcrumbs Returns specified number of breadcrumbs
 */
